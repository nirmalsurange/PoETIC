...
LABELS = [
    "Self-sufficient",
    "Context-dependent",
    "Emotion-impossible"  # Emotion-absent
]
...
def build_single_example(sentence, emotion, label=None):
    ...
    "Example output: Self-sufficient\n"
...
def main():
    ...
    # # Replace "Emotion-impossible" with "Emotion-not-expressed" in the gold labels if present
    # if 'context_dependency' in df.columns:
    #     df['context_dependency'] = df['context_dependency'].replace("Emotion-impossible", "Emotion-absent")
